...
<!--
  ...
  Fill them out with the right edge cases. For backend features, include
  authorization/ownership failures, invalid state transitions, pagination
  boundaries, malformed external service responses, and AI timeout or
  low-confidence behavior when applicable.
-->
