...
import { SkillProfileInput } from '../../application/ports/skill-profile-generator.port';
import { FastApiSkillProfileGeneratorClient } from './fastapi-skill-profile-generator.client';
...
describe('FastApiSkillProfileGeneratorClient', () => {
  ...
  const client = new FastApiSkillProfileGeneratorClient(
