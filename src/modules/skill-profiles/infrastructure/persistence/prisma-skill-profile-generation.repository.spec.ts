import { PrismaSkillProfileGenerationRepository } from './prisma-skill-profile-generation.repository';

describe('PrismaSkillProfileGenerationRepository', () => {
  it('supersedes older pending aliases before creating current candidates', async () => {
    ...
    const repository = new PrismaSkillProfileGenerationRepository(
      database as never,
    );
